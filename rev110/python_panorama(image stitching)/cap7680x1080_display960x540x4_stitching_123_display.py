...
#writer_1 = cv2.VideoWriter('1920x1080_cam1_of_1234.mp4', fourcc, 15.0, (1920,1080))
#writer_2 = cv2.VideoWriter('1920x1080_cam2_of_1234.mp4', fourcc, 15.0, (1920,1080))
#writer_3 = cv2.VideoWriter('1920x1080_cam3_of_1234.mp4', fourcc, 15.0, (1920,1080))
#writer_4 = cv2.VideoWriter('1920x1080_cam4_of_1234.mp4', fourcc, 15.0, (1920,1080))
...
#		writer_1 = cv2.VideoWriter('1920x1080_cam1_'+str(file_number).zfill(6)+'.jpg', fourcc, 15.0, (1920,1080))
#		writer_2 = cv2.VideoWriter('1920x1080_cam2_'+str(file_number).zfill(6)+'.jpg', fourcc, 15.0, (1920,1080))
#		writer_3 = cv2.VideoWriter('1920x1080_cam3_'+str(file_number).zfill(6)+'.jpg', fourcc, 15.0, (1920,1080))
#		writer_4 = cv2.VideoWriter('1920x1080_cam4_'+str(file_number).zfill(6)+'.jpg', fourcc, 15.0, (1920,1080))
